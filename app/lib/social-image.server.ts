...
function getCloudinarySocialImageUrl({
	...
	// all of the images
	let primaryFont = "armingrotesk-400.woff2";
	let titleFont = "armingrotesk-600.woff2";
	...
	let titleTransform = [
		...
		`l_text:${CLOUDINARY_FOLDER_NAME}:${titleFont}_160_line_spacing_-24:${encodedTitle}`, // textbox:font:content
	].join(",");
